...
%{
    open Challenge_ast.Expr
    open Challenge_ast.Script
...
%type <Challenge_ast.Expr.t> terminated_exp
%type <Challenge_ast.Script.t> terminated_pgm
